      ...
      for (const printer of networkPrinters) {
        try {
          ...
          printers.push({
            ...
            name: printer.name,
            type: 'network',
            connected: Math.random() > 0.5, // Simulate availability
            status: 'ready'
          });
        } catch (error) {
    ...
    <div className={`card-dark p-6 ${className}`}>
      ...
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center space-x-3">
          ...
          <div>
            <h3 className="text-lg font-semibold text-white">Receipt Printing</h3>
            <p className="text-gray-400 text-sm">Print professional receipts</p>
          </div>
        </div>
            ...
            >
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <div className="text-white font-medium">{printer.name}</div>
        ...
        <div className="space-y-4">
          ...
          {printHistory.length > 0 && (
            <div className="bg-dark-800/30 rounded-lg p-4 border border-dark-700/50">
              <h4 className="text-white font-medium mb-3">Recent Prints</h4>
      ...
      {availablePrinters.length === 0 && !isScanning && (
        <div className="text-center py-8">
          ...
          <h4 className="text-gray-400 font-medium mb-2">No Printers Found</h4>
