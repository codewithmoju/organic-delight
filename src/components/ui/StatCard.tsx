...
const StatCard: React.FC<StatCardProps> = ({
  ...
  return (
    <motion.div
      ...
      onClick={onClick}
      className={`relative overflow-hidden p-4 sm:p-6 rounded-3xl border transition-all duration-300
        ${isPrimary
    ...
    >
      ...
      {/* Decorative glow */}
      <div className={`absolute -right-4 -bottom-4 w-20 h-20 rounded-full opacity-20 blur-2xl pointer-events-none ${
